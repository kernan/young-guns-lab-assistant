 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person2 p2 = new Person2("Kyle Petrovich");
		  toPrint += p2.toString("902534657");
		  //Person3 replace P3 with your name
		  //and ggg000x with your gt num
		  Person3 p3 = new Person3("Robert Kernan");
		  toPrint += p3.toString("902438310");
          //Person4 replace P4 with your name
          //and ggg000x with your gt num
          Person4 p4 = new Person4("Philip Smith");
          toPrint += p4.toString("902669160");
